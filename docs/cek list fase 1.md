...
- Konsistensi istilah, definisi, potensi multitafsir → **Fase 2**
- Pertentangan dengan peraturan lain → **Fase 3**
...
daftar seluruh aturan berikut rincian "yang diperiksa" dan "yang TIDAK
diperiksa" — isinya harus sejalan dengan berkas ini.

Kalau ketiga sumber bertentangan, yang berlaku
`backend/app/rules/format_baku.py`. Riwayat lengkap tiap salah tandai yang
