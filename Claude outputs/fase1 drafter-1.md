...
3. **Baru setelah langkah 2 terbukti jalan**, tambahkan 4 aturan sisanya satu
   per satu di `rules/format_baku.py`.
4. **Baru setelah semua aturan jalan**, bangun penuh tiga lapis tampilan di
   bagian 6 (popup, komentar permanen, task pane) — jangan dikerjakan paralel
   dengan langkah 2–3.
5. **Terakhir**, lengkapi tabel rujukan KMK 527 (bagian 10) dengan kutipan
